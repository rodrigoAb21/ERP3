...
--
-- Host: 127.0.0.1    Database: proyectosi
-- ------------------------------------------------------
...
CREATE TABLE `cliente` (
  ...
  `id_categoriaCliente` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `migrations` VALUES (1,'2014_10_12_000000_create_users_table',1),(2,'2014_10_12_100000_create_password_resets_table',1),(3,'2017_10_02_202008_cliente_post_table',1),(4,'2017_10_02_234548_CategoriaCliente',1);
...
-- Dump completed on 2017-10-09 17:18:00
