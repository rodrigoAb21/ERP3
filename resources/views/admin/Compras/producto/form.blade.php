<div class="form-group {{ $errors->has('nombre') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="especificacion" type="text" id="especificacion" value="{{ $producto->especificacion or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="garantia" type="number" id="garantia" value="{{ $producto->garantia or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="puntosEquivale" type="number" id="puntosEquivale" value="{{ $producto->puntosEquivale or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="puntosPorVenta" type="number" id="puntosPorVenta" value="{{ $producto->puntosPorVenta or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="precioUCompra" type="number" id="precioUCompra" value="{{ $producto->precioUCompra or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="precioUVenta" type="number" id="precioUVenta" value="{{ $producto->precioUVenta or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="precioActual" type="number" id="precioActual" value="{{ $producto->precioActual or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="categoria_id" type="number" id="categoria_id" value="{{ $producto->categoria_id or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="visible" type="number" id="visible" value="{{ $producto->visible or ''}}" >
