<div class="form-group {{ $errors->has('nombre') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="nombre" type="text" id="nombre" value="{{ $post->nombre or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="especificacion" type="text" id="especificacion" value="{{ $post->especificacion or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="garantia" type="number" id="garantia" value="{{ $post->garantia or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="puntosEquivale" type="number" id="puntosEquivale" value="{{ $post->puntosEquivale or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="puntosPorVenta" type="number" id="puntosPorVenta" value="{{ $post->puntosPorVenta or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="precioUCompra" type="number" id="precioUCompra" value="{{ $post->precioUCompra or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="precioUVenta" type="number" id="precioUVenta" value="{{ $post->precioUVenta or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="precioActual" type="number" id="precioActual" value="{{ $post->precioActual or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="categoria_id" type="number" id="categoria_id" value="{{ $post->categoria_id or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="visible" type="number" id="visible" value="{{ $post->visible or ''}}" >
